/*--------------------------------------------------------------------
 * $Id: cloud3d.c 3125 2015-06-09 15:52:38Z Claudia.Emde $
 * 
			       ...
			       int            quiet )
{
  ...
  /* observer, sun in the back. If aziconv is set to  */
  ...
  if (spherical) {
    ...
    if (sample->bcond!=MCBCOND_ABSORB)
...
//  }
  ...
  /*switch on various special and experimental options*/
  /*planar switch:*/
...
{
  int isp=0, kc=0, status=0, hori_agree=0;
