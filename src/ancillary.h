/*--------------------------------------------------------------------
 * $Id: ancillary.h 3083 2014-12-08 12:53:21Z josef.gasteiger $
 * 
...
int optical_properties(input_struct input, output_struct *output, double  wvl, int ir, int iv1, int iv2, int iq, 
