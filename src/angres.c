/*--------------------------------------------------------------------
 * $Id: angres.c 2838 2012-12-19 11:06:09Z robert.buras $
 * 
...
int main(int argc, char **argv) 
{
  ...
  while (((180-sza)-acos(aumu[ia++])*180/PI) < 0 && ia < numu); it=ia-1; /* This one is fun:-) */
  ...
  ja = 0;
  delphirad = fabs(phi[1]-phi[0])*PI/180;
  while (fabs(phi0-phi[ja++])*PI/180 > delphirad); jt=ja-1;
